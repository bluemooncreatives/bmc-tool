  ...
  return (
    <div
      ...
      className={cn(
        ...
        'md:peer-data-[variant=floating]:m-2 md:peer-data-[variant=floating]:ms-0 md:peer-data-[variant=floating]:rounded-lg md:peer-data-[variant=floating]:border md:peer-data-[variant=floating]:shadow-sm md:peer-data-[variant=floating]:peer-data-[state=collapsed]:ms-2',
        className
      )}
      {...props}
    />
